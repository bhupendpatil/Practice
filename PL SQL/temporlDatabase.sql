...
insert into jy values(2,'PQR','8-Jun-1992','2-Mar-1972','');
insert into jy values(3,'LMN','5-Apr-2000','31-Jul-1980','');
insert into jy values(4,'XYZ','23-Jul-1996','15-Aug-1976','');
insert into jy values(5,'TUV','13-Mar-2008','23-Sep-1996','');

--    create procedure
create or replace procedure Caldate is
	cursor c1 is select * from jy;
	r c1%rowtype;
begin
	for r in c1 loop
		update jy set retiredate=add_months(r.dob,696)
		where accno=r.accno;
	end loop;
end;
/
...
--    Queries
--    a. Find all the employees who join the company on 02-03-1990
select * from jy where recdate = '02-Mar-90';
--    b. Find all the employees who retire on 02-03-1930
select * from jy where retiredate = '02-Mar-30';
...
SELECT company_name, no_shares* price
    FROM tb_shares
    WHERE no_shares* price > 1000 and transaction_time= to_date('11:45', 'hh24:mi');
